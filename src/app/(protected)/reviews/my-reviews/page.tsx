...
const MyReviewsPage = async ({ searchParams }: SearchParams) => {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Reviews you have written for travel plans
          </p>
        </div>
          ...
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mt-2">
                You haven&apos;t written any reviews yet. Start reviewing travel
                plans!
              </p>
            </div>
          </CardContent>
                ...
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious
                      href={
                        page > 1
                          ? `/reviews/my-reviews?page=${page - 1}`
                          : undefined
                      }
                      className={
                      ...
                      if (
                        ...
                        return (
                          <PaginationItem key={pageNum}>
                            <PaginationLink
                              href={`/reviews/my-reviews?page=${pageNum}`}
